...
BIZ = _client.get('name') or manifest.get('businessName', 'Frasheski Construction')
WEBSITE = _client.get('canonicalUrl') or manifest.get('canonicalUrl', '') or manifest.get('websiteUrl', 'https://frasheski-construction.aiovisibility.net')
...
PAGES_URL = (_client.get('pagesUrl') or manifest.get('pagesUrl') or 'https://aiovisibilityhub.github.io/frasheski-construction-ai-schemas-lnlg/') or (WEBSITE or '')
